...
public class Application {
    ...
    private static final String FEATURE_FOLDER_RELATIVE_PATH = "src/test/resources/stories";
    ...
    public static void main(String[] args) {
        ...
        TestCaseDto oneTestCase =  new TestCaseDto(TEST_CASE_NAME, GHERKIN_SCRIPT_EXTINCTION);
